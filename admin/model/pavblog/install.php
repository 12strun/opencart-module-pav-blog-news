...
(10, 21, 0, '2013-03-09', 1, 1, 227, 'data/pavblog/pav-i1.jpg', 'test test', '', 'Custom SEO Titlte', '2013-04-04', '&lt;iframe width=&quot;560&quot; height=&quot;315&quot; src=&quot;http://www.youtube.com/embed/6JnGBs88sL0&quot; frameborder=&quot;0&quot; allowfullscreen&gt;&lt;/iframe&gt;', '', 'prestashop', 0),
...
(9, 2, '', '', ''),
(9, 3, '', '', ''),
(10, 1, 'Тестовая статья для Opencartforum.ru', '&lt;p&gt;&quot;Но я должен объяснить вам, как все это ошибочная идея осуждения удовольствия и хваля боли родился и полное описание системы, и сам факт, что исследователь от истины, мастер счастливой жизни, которая, как говорили, вас здесь. Никто не отрицает, не любит, или избегает само удовольствие, потому что это удовольствие, но потому что они не знают, как искать удовольствий рационально столкнуться последствия, которые являются боли.&lt;/p&gt;\r\n', '&lt;p&gt;&lt;img align=&quot;left&quot; alt=&quot;&quot; src=&quot;http://d19ui706lkzefi.cloudfront.net/uploads/photo/file/33921/mechanize20130205-33-yyzp.png&quot; style=&quot;width: 350px; height: 250px;&quot; /&gt;Или также есть тех, кто любит себя горем, так как это горе печень, мозг, настолько ослеплены желанием, а потому, что иногда происходят время от времени такой природы, в которой труд и боль может обеспечить ему огромное удовольствие. Для того, чтобы тривиальный пример, кто из нас когда-либо обязуется трудоемкий физическими упражнениями, за исключением получить некоторое преимущество от него? Но кто не имеет права придираться к человеку, который хочет насладиться удовольствием, которое не имеет раздражающих последствия, или тот, кто избегает боли, которая не производит результирующий удовольствие? Или также есть тех, кто любит себя горем, так как это горе печень, мозг, настолько ослеплены желанием, а потому, что иногда происходят время от времени такой природы, в которой труд и боль может обеспечить ему огромное удовольствие. Для того, чтобы тривиальный пример, кто из нас когда-либо обязуется трудоемкий физическими упражнениями, за исключением получить некоторое преимущество от него? Но кто не имеет права придираться к человеку, который хочет насладиться удовольствием, которое не имеет раздражающих последствия, или тот, кто избегает боли, которая не производит результирующий удовольствие? Или также есть тех, кто любит себя горем, так как это горе печень, мозг, настолько ослеплены желанием, а потому, что иногда происходят время от времени такой природы, в которой труд и боль может обеспечить ему огромное удовольствие. Для того, чтобы тривиальный пример, кто из нас когда-либо обязуется трудоемкий физическими упражнениями, за исключением получить некоторое преимущество от него? Но кто не имеет права придираться к человеку, который хочет насладиться удовольствием, которое не имеет раздражающих последствия, или тот, кто избегает боли, которая не производит результирующий удовольствия?&lt;/p&gt;\r\n'),
(10, 2, '', '', ''),
(10, 3, '', '', ''),
...
(21, 2, '', ''),
(20, 2, '', ''),
(23, 2, 'Russian language', ''),
(20, 1, 'Демо категория 1-2', '&lt;p&gt;Добро пожаловать в устойчивое развитие крупномасштабных разработчиков и натянутое платформ. Нажмите Подробнее конкуренция всегда хороший слой термопасты&lt;/p&gt;\r\n\r\n&lt;p&gt;&amp;nbsp;&lt;/p&gt;\r\n'),
(23, 1, 'Демо категория 1-2-2', '&lt;p&gt;Добро пожаловать в устойчивое развитие крупномасштабных разработчиков и натянутое платформ. Нажмите Подробнее конкуренция всегда хороший слой термопасты&lt;/p&gt;\r\n'),
(21, 1, 'Демо категория 1 2-1', '&lt;p&gt;Добро пожаловать в устойчивое развитие крупномасштабных разработчиков и натянутое платформ. Нажмите Подробнее конкуренция всегда хороший слой термопасты&lt;/p&gt;\r\n'),
(21, 3, '', ''),
(23, 3, '', ''),
(20, 3, '', '');		
